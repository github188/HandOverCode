========================================================================
		ActiveX Control DLL : CBKMAP
========================================================================

ControlWizard has created this project for your CBKMAP ActiveX Control
...
that make up your CBKMAP ActiveX Control DLL.
...
CBKMapCtl.h
	This file contains the declaration of the CCBKMapCtrl C++ class.

CBKMapCtl.cpp
	This file contains the implementation of the CCBKMapCtrl C++ class.

CBKMapPpg.h
	This file contains the declaration of the CCBKMapPropPage C++ class.

CBKMapPpg.cpp
	This file contains the implementation of the CCBKMapPropPage C++ class.

CBKMapCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCBKMapCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CBKMap.rc.
