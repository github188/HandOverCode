...
namespace Platform
{
	...
	*******************************************************************************/
    TMCP_INTERFACE_SDK_API(int) Plat_QueryResource(int iResourceType, int iUserHandle);
	...
	*	返回值：字符串属性值，如果没有返回””
	*******************************************************************************/
    TMCP_INTERFACE_SDK_API(char*) Plat_GetValueStr(const char* propertyName, int iUserHandle);
