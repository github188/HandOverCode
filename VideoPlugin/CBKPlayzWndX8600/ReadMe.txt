========================================================================
		ActiveX Control DLL : CBKPLAYZWNDX
========================================================================

ControlWizard has created this project for your CBKPLAYZWNDX ActiveX Control
...
that make up your CBKPLAYZWNDX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CBKPlayzWndX control:

CBKPlayzWndXCtl.h
	This file contains the declaration of the CCBKPlayzWndXCtrl C++ class.

CBKPlayzWndXCtl.cpp
	This file contains the implementation of the CCBKPlayzWndXCtrl C++ class.

CBKPlayzWndXPpg.h
	This file contains the declaration of the CCBKPlayzWndXPropPage C++ class.

CBKPlayzWndXPpg.cpp
	This file contains the implementation of the CCBKPlayzWndXPropPage C++ class.

CBKPlayzWndXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCBKPlayzWndXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CBKPlayzWndX.rc.
