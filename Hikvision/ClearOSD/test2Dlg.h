...
// Construction
public:
	BOOL OnLoginHK(CString sIPaddr,CString sUser,CString sPwd,WORD wPort,int iChan);
	void WriteLog(LPCTSTR pstrFormat, ...);
	CString logfilename;
	//////////////////////////////////////////////////////////////////////////
// 	//20160720 第一步定义
// 	HINSTANCE dllHandleHKSS;	
// 	typedef BOOL (* HK_SHOWSTRING)(CString,UINT);
// 	HK_SHOWSTRING dllHK_SHOWSTRING;
	//////////////////////////////////////////////////////////////////////////
