...
typedef enum {
   ...
   Standard720P_24HZ              = 0x00000003,
   Standard720P_25HZ              = 0x00000004,
   Standard720P_30HZ              = 0x00000005,
   Standard720P_50HZ              = 0x00000006,
   Standard720P_60HZ              = 0x00000007,
   Standard1080I_50HZ             = 0x00000008,
   Standard1080I_60HZ             = 0x00000009,
   Standard1080P_24HZ             = 0x0000000a,
   Standard1080P_25HZ             = 0x0000000b,
   Standard1080P_30HZ             = 0x0000000c,
   Standard1080P_50HZ             = 0x0000000d,
   Standard1080P_60HZ             = 0x0000000e
} VideoStandard_t;               
