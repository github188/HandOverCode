...
LRESULT CCJMQDlg::OnQHMsg(WPARAM wParam, LPARAM lParam)
{
	...
	int ikch;
	ikch=atoi(sendstr);
	logz.WriteLog(dwlogID,"OnQHMsg sendstr=%s",sendstr);
...
BOOL CCJMQDlg::OnInitDialog()
{
	...
	dwlogID=logz.Register("合码器主程序.log");
	...
	strcpy(m_NotifyIcon.szTip, _T("合码器 V1.0"));//托盘程序显示名称
	...
	logz.WriteLog(dwlogID,"合码器 InitInstance V1.0 Build 20171009 2142");
	//////////////////////////////////////////////////////////////////////////
...
// 	}
	if (__argc <2 )
	{
		...
		ShellExecute(NULL,"open",ClientFile,"CHMQ.exe",NULL,SW_HIDE);
	}
...
void CCJMQDlg::OnTimer(UINT nIDEvent) 
{
	// TODO: Add your message handler code here and/or call default
	if (bQueryStart==false)
	{
