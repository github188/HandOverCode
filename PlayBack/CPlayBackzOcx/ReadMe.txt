========================================================================
		ActiveX Control DLL : CPLAYBACKZOCX
========================================================================

ControlWizard has created this project for your CPLAYBACKZOCX ActiveX Control
...
that make up your CPLAYBACKZOCX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CPlayBackzOcx control:

CPlayBackzOcxCtl.h
	This file contains the declaration of the CCPlayBackzOcxCtrl C++ class.

CPlayBackzOcxCtl.cpp
	This file contains the implementation of the CCPlayBackzOcxCtrl C++ class.

CPlayBackzOcxPpg.h
	This file contains the declaration of the CCPlayBackzOcxPropPage C++ class.

CPlayBackzOcxPpg.cpp
	This file contains the implementation of the CCPlayBackzOcxPropPage C++ class.

CPlayBackzOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCPlayBackzOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CPlayBackzOcx.rc.
